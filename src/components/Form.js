...
const schema = yup.object({
    ...
    return (
      <>
        <div className="App mt-10 w-1/3 mx-auto">
          ...
          >
            {errors.fornavn && <p className="text-orange-600">{errors.fornavn?.message}</p>}
            <input
              {...register("fornavn")}
              type="text"
              placeholder="Fornavn"
  ...
  "
            />
            {errors.bekraeftemail && <p className="text-orange-600">{errors.bekraeftemail.message}</p>}
            <input
  ...
  "
            />
              ...
              <button className="bg-green-500 rounded-md mt-10 cursor-pointer pt-1 pb-1 pl-10 pr-10 text-white" onClick={() => {
                <Link to="/Card" />}}>
                Videre
              </button>
          </form>
